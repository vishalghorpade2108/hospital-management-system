...
export default function Sidebar({ userName, onLogout, onSelect }) {
      ...
      >
        ...
        <div>
          ...
          <ul className="space-y-5 text-lg font-medium">
            ...
            >
              <FaCalendarAlt size={22} /> My Appointments
            </li>
            ...
            >
              <AiOutlineUserAdd size={22} /> Book Appointment
            </li>
            ...
            >
              <BsFileMedical size={22} /> Medical History
            </li>
